...
_CTX_CALLER_APP = "api-pac-context"
_CTX_ACTOR_ID = "ctx-gpt-agent"
_CTX_ACTOR_NAME = "Agente GPT Contexto PAC"


class ApiDelpiGatewayError(Exception):
    def __init__(self, message: str, *, status_code: int | None = None) -> None:
        super().__init__(message)
        self.status_code = status_code


class ApiDelpiGateway:
    ...
    def _headers(self, *, content_type: str | None = "application/json") -> dict[str, str]:
        headers: dict[str, str] = {
            ...
            "X-Delpi-Caller-App": _CTX_CALLER_APP,
            "X-Delpi-Actor-Id": _CTX_ACTOR_ID,
            "X-Delpi-Actor-Name": _CTX_ACTOR_NAME,
        }
        if content_type:
    ...
    def request_json(
        ...
        *,
        ...
        if not self.configured:
            raise ApiDelpiGatewayError("Gateway api-delpi não configurado.")
